  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="bg-muted/20 py-8 sm:py-12 px-4 border-t border-border/50">
        <div className="container mx-auto max-w-6xl text-center flex flex-col items-center gap-3">
          <div className="flex items-center gap-8">
            <img 
              src="/logo.png" 
              alt="Windexs логотип" 
              className="h-32 sm:h-56 w-auto max-w-full"
            />
            <span className="hidden sm:inline text-3xl sm:text-4xl font-semibold text-foreground">
              кулинар
            </span>
          </div>
